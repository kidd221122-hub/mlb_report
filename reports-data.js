...
var reports = {
    ...
    "投注策略": [
        ...
        },
        {
            ...
            "date": "2026-07-15",
            "tags": ["紀錄", "系統", "EV"],
            "content": "# 投注紀錄系統\n\n## 一、系統架構\n\n```\n投注紀錄系統/\n  bet_tracker.py          # Python 程式\n  bets.csv                # 原始數據\n  dashboard.html          # 視覺化儀表板\n  README.md               # 使用說明\n```\n\n## 二、需要紀錄的欄位\n\n| 欄位 | 說明 | 範例 |\n|------|------|------||\n| `date` | 比賽日期 | 2026-07-15 |\n| `home_team` | 主隊 | Dodgers |\n| `away_team` | 客隊 | Yankees |\n| `bet_type` | 玩法 | Over/Under |\n| `pick` | 選擇 | Over 8.5 |\n| `odds` | 賠率 | 1.85 |\n| `stake` | 下注金額 | 1000 |\n| `model_probability` | 模型預測概率 | 0.58 |\n| `result` | 結果 | Win/Loss |\n| `profit_loss` | 盈虧 | +850/-1000 |\n\n## 三、期望值計算\n\nEV = (勝率 x 贏的钱) - (敗率 x 押的钱)\n\n### 範例：55% 命中率，賠率 1.85\n\n```\n每場押 1000 元，500 場：\n  贏 275 場，輸 225 場\n  贏的钱：275 x 1850 = 508,750\n  押的钱：500 x 1000 = 500,000\n  淨獲利：+8,750 元\n```\n\n## 四、資金管理\n\n- 每場投注不超過總資金的 **3-5%**\n- 連續輸 5 場 -> 降碼到 50%\n- 連續贏 5 場 -> 升碼到 150%\n"
        }
    ],
    "法律研究": [
        {
            "id": "workplace-bullying-law",
            "title": "台灣職場霸凌法律指南",
            "date": "2026-07-15",
            "tags": ["法律", "職場霸凌", "職安法"],
            "content": "# 台灣職場霸凌法律指南\n\n> **更新日期：2026 年 7 月**\n\n## 重大消息：職場霸凌防治法 2026 年 7 月 1 日正式上路\n\n2025 年 12 月 11 日，立法院三讀通過《職業安全衛生法》修正案，新增「職場霸凌防治」專章。\n\n## 一、什麼是職場霸凌？\n\n### 五大認定要件（必須同時符合）\n\n| 要件 | 說明 |\n|------|------||\n| **1 發生在勞動場所** | 涵蓋辦公室、出差及外勤地點 |\n| **2 行為人是內部員工** | 主管、同事都算 |\n| **3 逾越業務必要性** | 關鍵界線！ |\n| **4 具有反覆或持續性** | 重大情節一次也算 |\n| **5 致使身心健康危害** | 精神壓力、名譽受損等 |\n\n## 二、6 大霸凌類型與法律責任\n\n### 肢體霸凌\n- **刑法第 277、278 條**【傷害罪】\n- **民法第 184 條**【侵權行為損害賠償】\n\n### 關係霸凌\n- **民法第 195 條**【人格權侵害】\n- **職安法第 6 條第 2 項第 3 款**\n\n### 語言霸凌\n- **刑法第 305 條**【恐嚇罪】\n- **刑法第 309 條**【公然侮辱罪】\n\n### 網路霸凌\n- **刑法第 310 條**【誹謗罪】\n\n## 三、企業違規罰則\n\n| 違規項目 | 罰鍰 |\n|----------|------||\n| 未建立防治制度 | 最高 **300 萬** |\n| 情節嚴重 | 最高 **450 萬** |\n| 知悉不處理 | **3 萬-75 萬** |\n\n## 四、受害者自救 6 步驟\n\n1. **蒐證**：截圖、錄音、醫療紀錄\n2. **向公司申訴**：人資或申訴處理單位\n3. **向勞工局申訴**：勞動檢查機構\n4. **民事求償**：民法 184、195 條\n5. **刑事告訴**：刑法相關條文\n6. **勞基法第 14 條終止契約**：請資遣費\n"
        }
    ],
    "冰店推薦": [
        {
            "id": "taichung-ice-shops",
            "title": "中科附近冰店推薦",
            "date": "2026-07-16",
            "tags": ["台中", "冰店", "中科"],
            "content": "# 中科附近冰店推薦\n\n## 最近距離（車程 5-10 分鐘）\n\n### 1 一把揪冰品屋\n\n| 項目 | 資訊 |\n|------|------||\n| **地址** | 台中市西屯區重慶路 189 號 |\n| **特色** | 21 種手工配料、CP 值超高 |\n| **推薦** | 超級芒果綿綿冰 $110 |\n| **距離中科** | 車程約 5-8 分鐘 |\n\n### 2 逢甲品冰瀑彎豆冰\n\n| 項目 | 資訊 |\n|------|------||\n| **地址** | 台中市西屯區文華路 19-4 號 |\n| **電話** | 04-2451-7214 |\n| **特色** | 豆冰、冰淇淋、大豆綠豆冰沙 |\n| **距離中科** | 車程約 5-8 分鐘 |\n\n## 東海商圈（車程 10-15 分鐘）\n\n### 3 東海何媽媽冰店\n\n| 項目 | 資訊 |\n|------|------||\n| **地址** | 台中市龍井區台灣大道五段 3 巷弄內 |\n| **特色** | 東海老字號、每年夏天排隊 |\n| **推薦** | 芒果布丁牛奶冰（夏季限定） |\n\n## 建議\n\n如果不想跑遠，首選**一把揪冰品屋**或**逢甲品冰瀑彎豆冰**，距離最近且 CP 值高！\n"
        }
    ]
};
